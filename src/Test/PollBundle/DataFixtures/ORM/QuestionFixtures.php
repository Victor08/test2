...
class QuestionFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $question1->setType(1);
        $question1->setTest($manager->merge($this->getReference('test-1')));
        ...
        $question2->setType(1);
        $question2->setTest($manager->merge($this->getReference('test-1')));
        ...
        $question3->setType(2);
        $question3->setTest($manager->merge($this->getReference('test-1')));
        $manager->persist($question3);
        
        $question4 = new Question();
        $question4->setTitle('04 whats the weather like today?');
        $question4->setType(1);
        $question4->setTest($manager->merge($this->getReference('test-2')));
        ...
        $question5->setType(1);
        $question5->setTest($manager->merge($this->getReference('test-2')));
        ...
        $question6->setType(2);
        $question6->setTest($manager->merge($this->getReference('test-2')));
        ...
        $question7->setType(1);
        $question7->setTest($manager->merge($this->getReference('test-3')));
        ...
        $question8->setType(2);
        $question8->setTest($manager->merge($this->getReference('test-3')));
        ...
        $question9->setType(1);
        $question9->setTest($manager->merge($this->getReference('test-4')));
        ...
        $question10->setTest($manager->merge($this->getReference('test-4')));
        ...
        $question11->setTest($manager->merge($this->getReference('test-4')));
        ...
        $question12->setTest($manager->merge($this->getReference('test-4')));
        ...
        $question13->setTest($manager->merge($this->getReference('test-4')));
